...
export source_image := env("SOURCE_IMAGE", "fedora-bootc:42")
...
#
# Arguments:
#   $target_image - The tag you want to apply to the image (default: homesever).
...
#
# Example usage:
#   just build homeserver latest
#
# This will build an image 'homeserver:latest'
#
